...
$root_path = "../../";
$page_title = "Open Support Ticket | Admin Control";
...
<div class="main-dashboard text-start">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap g-2">
        <div>
            <h2 class="fw-bold text-dark mb-1">🎫 Raise Support Ticket</h2>
            <p class="text-muted mb-0">Open an inquiry for infrastructure fixes, accounts issues, IT requests, or report general complaints.</p>
        </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subject" class="form-control" placeholder="e.g. Printer issue in HR office" required>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="8" placeholder="Elaborate on the issue, error codes, logs, etc..." required></textarea>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-semibold">Upload Attachment (Screenshot / Document)</label>
                            <input type="file" name="attachment" class="form-control">
                            <div class="form-text">Accepted format: Images (JPG, PNG), PDF, TXT. Max size 2MB.</div>
                        </div>

                        <div class="text-end">
                            <button type="submit" name="create_ticket" class="btn btn-success px-5 py-2 fw-semibold">
                                <i class="fa fa-check me-1"></i> Open Ticket
                            </button>
                        </div>
