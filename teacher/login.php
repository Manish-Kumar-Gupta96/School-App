...
<head>
    ...
    <title>Teacher Portal Login | VIC ERP</title>
    <!-- Bootstrap (Local) -->
...
<div class="login-card">
    ...
    <div class="login-banner">
        ...
        <p class="text-white-50 mt-3 mb-0">Record student daily attendance, upload academic exam progress marks, and file leave applications efficiently.</p>
    </div>

    <!-- Right Form -->
    <div class="login-form-container text-start">
        <h3 class="fw-bold text-dark mb-2">Teacher Log In</h3>
        <p class="text-muted mb-4">Enter email or employee ID to authenticate</p>
        ...
        <form method="POST">
            <div class="mb-3">
                <label class="form-label fw-semibold text-muted small">Email or Employee ID</label>
                <div class="input-group">
                    <span class="input-group-text bg-light border-end-0 text-muted"><i class="fa fa-envelope"></i></span>
                    <input type="text" name="username" class="form-control border-start-0" placeholder="e.g. TCH101 or teacher@example.com" required>
                </div>
            </div>
