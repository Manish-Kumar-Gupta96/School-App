...
<div class="main-dashboard text-start" style="padding: 20px 0;">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap g-2">
        <div>
            ...
            <p class="text-muted mb-0">Open and manage support tickets for classroom facilities, IT issues, syllabus adjustments, or HR payroll requests.</p>
        </div>
        <a href="create-ticket.php" class="btn btn-primary" style="background-color: #198754; border-color: #198754;">
                            ...
                            <?php foreach($tickets as $t): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="pe-4 text-center">
                                        <a href="replies.php?id=<?= $t['id'] ?>" class="btn btn-sm btn-outline-primary" style="color: #198754; border-color: #198754;">
