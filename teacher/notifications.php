...
$root_path = "../";
$page_title = "Teacher Notifications | Teacher Portal";
...
if (isset($_GET['read_id'])) {
    ...
    ");
    $stmt->execute([$read_id, $teacher_id]);
...
$stmt = $pdo->prepare("
    ...
    WHERE r.user_id = ? AND r.user_type = 'TEACHER'
    ORDER BY n.id DESC
");
...
<div class="main-dashboard text-start" style="padding: 20px 0;">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1">🔔 Teacher Notifications</h2>
            <p class="text-muted mb-0">Review announcements, staff directives, and support inquiries.</p>
        </div>
    </div>
