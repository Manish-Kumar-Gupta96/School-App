...
$root_path = "../";
$page_title = "Open Support Ticket | Parent Portal";
...
<div class="main-dashboard text-start" style="padding: 20px 0;">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap g-2">
        <div>
            ...
            <p class="text-muted mb-0">Open an inquiry for your child's fees, academic progress reports, transport issues, or school management concerns.</p>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-8">
            <div class="card shadow border-0" style="border-radius: 15px;">
                <div class="card-header bg-primary text-white py-3" style="border-radius: 15px 15px 0 0; background-color: #7c3aed !important;">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subject" class="form-control" placeholder="e.g. Discrepancy in Q1 Fee Receipt" required>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="8" placeholder="Please describe your query or problem in detail..." required></textarea>
                        </div>
