...
$root_path = "../";
$page_title = "Support Tickets | Parent Portal";
...
$stmt = $pdo->prepare("
    ...
    WHERE t.user_id = ? AND t.user_type = 'PARENT'
    ORDER BY t.id DESC
");
...
<div class="main-dashboard text-start" style="padding: 20px 0;">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap g-2">
        <div>
            ...
            <p class="text-muted mb-0">Manage support tickets for child progress queries, fee billing, hostel, transport, or general school concerns.</p>
        </div>
        <a href="create-ticket.php" class="btn btn-primary" style="background-color: #7c3aed; border-color: #7c3aed;">
                            ...
                            <?php foreach($tickets as $t): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="pe-4 text-center">
                                        <a href="replies.php?id=<?= $t['id'] ?>" class="btn btn-sm btn-outline-primary" style="color: #7c3aed; border-color: #7c3aed;">
